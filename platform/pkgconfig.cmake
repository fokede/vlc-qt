...
# Installation #
################
INSTALL(FILES ${CMAKE_BINARY_DIR}/platform/pkgconfig/lib${VLCQT_CORE_NAME}.pc DESTINATION ${CMAKE_INSTALL_FULL_LIBDIR}/pkgconfig)
INSTALL(FILES ${CMAKE_BINARY_DIR}/platform/pkgconfig/lib${VLCQT_WIDGETS_NAME}.pc DESTINATION ${CMAKE_INSTALL_FULL_LIBDIR}/pkgconfig)
IF(QT_VERSION MATCHES 5)
    INSTALL(FILES ${CMAKE_BINARY_DIR}/platform/pkgconfig/lib${VLCQT_QML_NAME}.pc DESTINATION ${CMAKE_INSTALL_FULL_LIBDIR}/pkgconfig)
ENDIF()
